...
| `routes/adminSecurity.routes.js` | 141 | GET | `/history` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 143 | GET | `/attempts` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 145 | GET | `/web-observation` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 157 | GET | `/locked-accounts` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 169 | POST | `/locked-accounts/unlock` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 192 | POST | `/ban` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 197 | POST | `/unban` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 201 | POST | `/make-indefinite` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 211 | POST | `/trust` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 225 | DELETE | `/trust` | sí | platform-admin | no | sí | — | — |
