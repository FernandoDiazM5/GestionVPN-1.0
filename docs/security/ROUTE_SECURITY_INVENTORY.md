...
| `routes/adminSecurity.routes.js` | 152 | GET | `/locked-accounts` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 155 | POST | `/locked-accounts/unlock` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 168 | POST | `/ban` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 173 | POST | `/unban` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 177 | POST | `/make-indefinite` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 187 | POST | `/trust` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 201 | DELETE | `/trust` | sí | platform-admin | no | sí | — | — |
