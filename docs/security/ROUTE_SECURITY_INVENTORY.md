...
| `routes/adminSecurity.routes.js` | 128 | GET | `/history` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 130 | GET | `/attempts` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 132 | GET | `/web-observation` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 139 | GET | `/locked-accounts` | sí | platform-admin | no | n/a | — | — |
| `routes/adminSecurity.routes.js` | 142 | POST | `/locked-accounts/unlock` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 155 | POST | `/ban` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 160 | POST | `/unban` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 164 | POST | `/make-indefinite` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 174 | POST | `/trust` | sí | platform-admin | no | sí | — | — |
| `routes/adminSecurity.routes.js` | 188 | DELETE | `/trust` | sí | platform-admin | no | sí | — | — |
