...
| `routes/admin.routes.js` | 497 | GET | `/invitations` | sí | platform-admin | no | n/a | — | — |
| `routes/admin.routes.js` | 512 | POST | `/invitations/:id/link` | sí | platform-admin | no | n/a | network-admin | — |
...
| `routes/ai.routes.js` | 60 | GET | `/status` | sí | — | no | n/a | — | — |
| `routes/ai.routes.js` | 87 | POST | `/consent` | sí | — | no | sí | — | — |
| `routes/ai.routes.js` | 93 | POST | `/device-analysis` | sí | — | no | sí | — | — |
| `routes/ai.routes.js` | 111 | POST | `/network-analysis` | sí | — | no | sí | — | — |
| `routes/ai.routes.js` | 157 | GET | `/analyses` | sí | — | no | n/a | — | — |
| `routes/ai.routes.js` | 166 | POST | `/analyses/device-history` | sí | — | no | sí | — | — |
| `routes/ai.routes.js` | 183 | GET | `/analyses/:uuid` | sí | — | no | n/a | — | — |
| `routes/ai.routes.js` | 192 | DELETE | `/analyses/:uuid` | sí | — | no | n/a | — | — |
...
| `routes/federatedAuth.routes.js` | 32 | GET | `/config` | no | — | no | n/a | — | — |
| `routes/federatedAuth.routes.js` | 66 | GET | `/csrf` | no | — | no | n/a | — | — |
| `routes/federatedAuth.routes.js` | 74 | GET | `/link-status` | sí | — | no | n/a | — | — |
| `routes/federatedAuth.routes.js` | 94 | POST | `/link` | sí | — | sí | sí | — | — |
| `routes/federatedAuth.routes.js` | 181 | POST | `/unlink` | sí | — | sí | sí | — | — |
...
| `routes/integrations.routes.js` | 51 | GET | `/mikrowisp/telegram-forums/:groupId/topics/bulk/preview` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 52 | GET | `/mikrowisp/telegram-forums/:groupId/topics/bulk/latest` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 53 | POST | `/mikrowisp/telegram-forums/:groupId/topics/bulk` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 54 | GET | `/mikrowisp/telegram-forums/:groupId/topics/bulk/:jobId` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 55 | POST | `/mikrowisp/telegram-forums/:groupId/topics/bulk/:jobId/pause` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 56 | POST | `/mikrowisp/telegram-forums/:groupId/topics/bulk/:jobId/resume` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 57 | GET | `/telegram-groups/:groupId/fiber-routes` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 58 | POST | `/telegram-groups/:groupId/fiber-routes` | sí | — | no | sí | — | — |
| `routes/integrations.routes.js` | 59 | GET | `/telegram-groups/:groupId/fiber-routes/:routeId` | sí | — | no | n/a | — | — |
| `routes/integrations.routes.js` | 60 | POST | `/telegram-groups/:groupId/fiber-routes/:routeId/elements` | sí | — | no | sí | — | — |
| `routes/integrations.routes.js` | 61 | POST | `/telegram-groups/:groupId/fiber-routes/:routeId/measurements` | sí | — | no | sí | — | — |
| `routes/integrations.routes.js` | 62 | POST | `/telegram-groups/:groupId/fiber-routes/:routeId/evidence` | sí | — | no | sí | — | — |
| `routes/integrations.routes.js` | 63 | POST | `/telegram-groups/:groupId/fiber-routes/:routeId/status` | sí | — | no | sí | — | — |
| `routes/integrations.routes.js` | 65 | PUT | `/:provider` | sí | — | no | **no** | — | `BODY_SCHEMA_MISSING`, `PARAM_SCHEMA_MISSING` |
| `routes/integrations.routes.js` | 66 | POST | `/:provider/test` | sí | — | no | n/a | — | `PARAM_SCHEMA_MISSING` |
| `routes/integrations.routes.js` | 67 | DELETE | `/:provider` | sí | — | no | n/a | — | `PARAM_SCHEMA_MISSING` |
...
| `routes/nodes/scan.routes.js` | 50 | POST | `/node/scan-stream` | sí | — | no | sí | network-admin | — |
| `routes/nodes/tags.routes.js` | 16 | GET | `/node/tags` | sí | — | no | n/a | sql | — |
| `routes/nodes/tags.routes.js` | 41 | POST | `/node/tag/save` | sí | — | no | sí | sql | — |
| `routes/platformIntegrations.routes.js` | 7 | GET | `/` | sí | — | no | n/a | — | — |
...
| `routes/settings.routes.js` | 39 | GET | `/settings/get` | sí | platform-admin | no | n/a | sql | — |
| `routes/settings.routes.js` | 67 | GET | `/settings/management-supernet-preview` | sí | platform-admin | no | n/a | network-admin | — |
| `routes/settings.routes.js` | 74 | POST | `/settings/test-core-connection` | sí | platform-admin | no | sí | network-admin | — |
| `routes/settings.routes.js` | 100 | POST | `/settings/save` | sí | platform-admin | no | sí | sql, network-admin | — |
| `routes/settings.routes.js` | 179 | POST | `/settings/test-error-email` | sí | platform-admin | no | n/a | — | — |
...
| `routes/team.routes.js` | 394 | POST | `/invitations/:id/accept` | sí | — | no | sí | network-admin | — |
| `routes/team.routes.js` | 448 | GET | `/members` | sí | — | no | n/a | — | — |
| `routes/team.routes.js` | 454 | GET | `/invitations` | sí | OWNER | no | n/a | network-admin | — |
| `routes/team.routes.js` | 469 | PATCH | `/member/:userId` | sí | OWNER | no | sí | sql | — |
| `routes/team.routes.js` | 531 | DELETE | `/member/:userId` | sí | OWNER | no | n/a | sql, network-admin | — |
| `routes/team.routes.js` | 588 | POST | `/invitation/:id/revoke` | sí | OWNER | no | n/a | network-admin | — |
