        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="pl-6 pr-2 py-1 text-2xs border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-1 focus:ring-indigo-300 w-36"
            />
      ...
      {poll.stations.length > 0 && (
        <div className="overflow-x-auto">
          <div style={{ minWidth: `${minW}px` }}>
            <div className="grid bg-slate-100 border-b border-slate-200 text-2xs font-bold text-slate-500 uppercase tracking-wider"
