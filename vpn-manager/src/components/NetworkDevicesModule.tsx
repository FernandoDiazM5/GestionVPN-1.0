                    ...
                    <Fragment key={dev.ip}>
                      ...
                      >
                        ...
                        <div className="px-3 py-3 flex items-center justify-end gap-1.5">
                          ...
                          {/* Sync: siempre visible cuando hasStats */}
                          {hasStats && (
                            <button
                              onClick={() => {
                                if (isSaved) {
                          ...
                          {/* Ficha: visible cuando hasStats o isSaved */}
                          {(hasStats || isSaved) && (
                            <button
                              onClick={() => {
                                if (isSaved) {
                          ...
                          {/* Guardar: solo cuando no está guardado y hay nodo seleccionado */}
