  ...
  return (
    <div className="space-y-1.5">
      ...
      {failedAt != null && failedAt > 0 && visible >= steps.length && (
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg text-xs border bg-amber-50 border-amber-100 anim-fade-in dark:bg-amber-500/10 dark:border-amber-500/30">
