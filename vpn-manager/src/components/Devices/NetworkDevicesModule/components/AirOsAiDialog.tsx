        ...
        {!analysis ? (
          <>
            ...
            <dl className="grid grid-cols-2 gap-3 text-sm">
              <div className="rounded-lg bg-slate-50 p-3 dark:bg-slate-800"><dt className="text-xs text-slate-500">Vista seleccionada</dt><dd className="font-bold">{pending?.kind === 'NETWORK' ? 'Red visible' : 'Equipo individual'}</dd></div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <button onClick={submit} disabled={busy} className="btn-primary btn-md min-h-11 flex items-center gap-2">
