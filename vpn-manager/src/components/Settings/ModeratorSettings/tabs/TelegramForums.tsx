...
export default function TelegramForums() {
  ...
  return <div className="space-y-3 rounded-xl border border-violet-200 bg-violet-50 p-3 dark:border-violet-800/60 dark:bg-violet-500/10">
    <div><p className="text-sm font-bold text-violet-950 dark:text-violet-100">Clientes en Telegram</p><p className="mt-1 text-xs leading-5 text-violet-800 dark:text-violet-200">Crea manualmente un supergrupo privado, activa Temas y agrega el bot como administrador con permisos para temas, invitaciones y retiros. Joinpoint sólo registra grupos y temas conocidos; no guarda conversaciones.</p></div>
