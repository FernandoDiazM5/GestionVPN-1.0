...
const statusClass = (status: string) => status === 'ACTIVE' ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-300' : status === 'CLOSED' ? 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300' : status.includes('REPAIR') || status.includes('UNKNOWN') ? 'bg-amber-50 text-amber-700 dark:bg-amber-500/10 dark:text-amber-300' : 'bg-rose-50 text-rose-700 dark:bg-rose-500/10 dark:text-rose-300';
