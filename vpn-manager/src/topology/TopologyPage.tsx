...
import TopologyListView from './components/list/TopologyListView';
...
import TowerDetailPanel from './components/panels/TowerDetailPanel';
  ...
  return (
    <div className="flex h-[calc(100vh-140px)] bg-slate-50 rounded-xl border border-slate-200 overflow-hidden shadow-sm">
      ...
      <div className="flex-1 flex flex-col relative min-w-0">
        ...
        {viewMode === 'canvas' ? <TopologyCanvas /> : <TopologyListView />}
        <DeviceDetailPanel />
        <TowerDetailPanel />
      </div>
    </div>
