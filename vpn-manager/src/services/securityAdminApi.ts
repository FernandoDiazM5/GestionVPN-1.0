...
export interface SecurityStatus { success: true; jails: SecurityJail[]; trusted: string[]; trustedMetadata: Array<Record<string, unknown>>; currentIp:string }
...
export const securityAdminApi = {
  ...
  attempts: (target?: string) => get<{ success:true; attempts:Array<Record<string, unknown>> }>(
